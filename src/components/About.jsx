      ...
      <div className='flex flex-col justify-center items-center w-full h-full'>
        <div className='max-w-[1000px] w-full grid grid-cols-2 gap-8'>
          ...
          <div className='max-w-[1000px] w-full grid sm:grid-cols-2 gap-8 px-4'>
            ...
            <div>
              <p>As a Software Engineering student at the University of Nebraska-Lincoln,
                 I've earned a Global Excellence Scholarship and consistently made the Dean's
                  List. My professional journey
                    includes roles as a Software Developer Intern at Nightfox Audio Inc., an IT Assistant at
                     ITS Huskertech, and a Teaching Assistant at UNL. I'm driven by the challenge of solving
